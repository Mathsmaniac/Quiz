"""
quiz_frameworkv2.py
In this version I finished implementing the 'check' button
Including making sure the input box is not blank
"""
...
class Root(tk.Tk):
    def __init__(self):
        ...
        self.checkbutton = ttk.Button(self.mainframe, text="Check",
                                      command=self.check)
        self.checkbutton.grid(row=4, column=0, padx=10, pady=10)
    ...
    def next(self):
        # Hide answerlabel and put checkbutton back to "check"
